...
{
    [PermissionGroupName("Employees", "الموظفين")]
    public class EmployeesPermissions : IPermissionContributor
    {
        public const string Group = nameof(EmployeesPermissions) + "Group.";
