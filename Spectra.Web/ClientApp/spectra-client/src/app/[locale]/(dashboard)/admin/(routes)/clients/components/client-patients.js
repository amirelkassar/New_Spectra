        ...
        <ActionMenu
          ...
          pathEdit={
            params.orgId
              ...
              : ROUTES.ADMIN.CLIENTS.FAMILY.PATIENTSEDIT(
                  params.familyId
                )
          }
        />
        ...
        {patients.map((patient) => (
          ...
          >
            <div className=' absolute left-4 top-[18px]'>
              <MenuActions
                type={2}
                path={ROUTES.ADMIN.CLIENTS.PATIENTSDETAILS.DASHBOARD(
                  patient.id
                )}
                pathEdit={
            ...
            <Link
              href={ROUTES.ADMIN.CLIENTS.PATIENTSDETAILS.DASHBOARD(
                patient.id
              )}
            ...
            >
              ...
              <div className='flex items-center gap-3'>
                ...
                <strong className='text-xs mdl:text-base'>
                  {patient.name}
                </strong>
              </div>{' '}
              <div className='flex items-center gap-3'>
