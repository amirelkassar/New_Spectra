...
function Nominations() {
  return (
    <Card>
      <h2 className='text-base mdl:text-lg mb-4  mdl:mb-10'>
        الترشيحات
      </h2>
      <div>
        <h3 className='text-base mdl:text-lg font-Regular mb-6'>
          الباقات
        </h3>
      ...
      <div className='mt-11'>
        <h3 className='text-base mdl:text-lg font-Regular mb-7'>
          الخدمات
        </h3>
