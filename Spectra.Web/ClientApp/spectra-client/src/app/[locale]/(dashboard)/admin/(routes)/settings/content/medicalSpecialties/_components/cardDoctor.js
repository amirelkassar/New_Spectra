    ...
    <div className='lgl:min-w-[230px] flex-1'>
      <div className='flex items-center justify-center gap-4 mb-4'>
        <button
          ...
          className='border hover:bg-red z-50 border-red rounded-[10px] size-8 lgl:size-[48px] flex items-center justify-center p-2 lgl:p-3'
        >
      ...
      <div className='pt-[72px] lgl:pt-[122px] mt-[-56px] lgl:mt-[-110px] bg-gradient-to-b from-gray to-white rounded-[10px]'>
        <h2 className='text-[14px] lgl:text-[20px] font-Bold text-center'>
          احمد محمد كمال
        </h2>
        <h3 className='text-[14px] lgl:text-[20px] text-center'>
          {' '}
          اخصائى نفسى
        </h3>
        <div className='bg-greenMain w-[70px] lgl:w-[112px] flex justify-center items-center gap-2 mx-auto mt-1 lgl:mt-3 rounded-[10px] py-1 h-7 lgl:h-[40px]'>
          ...
          <p className='text-white text-[14px] lgl:text-[20px] font-Bold'>
            4.9
          </p>
        </div>
      </div>
