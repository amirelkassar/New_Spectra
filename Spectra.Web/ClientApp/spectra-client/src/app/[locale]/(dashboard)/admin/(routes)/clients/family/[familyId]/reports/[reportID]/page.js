...
function page() {
  return (
    <div className='flex flex-col gap-6 h-fit flex-1'>
      <Card>
        ...
        <div className='flex flex-col gap-5 w-full'>
          ...
          <div className='pb-5 border-b border-grayLight'>
            ...
            <p className='text-sm lg:text-xl font-Regular'>
              يشمل الفحص الشامل على التحاليل والفحوصات المخبرية،
              وفحوصات الأشعة التشخيصية، وغيرها من الإجراءات، ويتم
              اختيار ما هو مناسب للمريض وفقاً لعدة عوامل، كحالة المريض
              الصحية، وعمره، وجنسه، وعوامل أخرى. ينصح بإجراء الفحص
              الشامل كل 5 سنوات للأشخاص البالغين من عمر 18-40، وكل سنة
              إلى ثلاث سنوات بعد سن الأربعين. وهناك مجموعة من الفحوصات
      ...
      <Card>
        <h2 className='font-Bold text-sm mdl:text-lg mb-8'>
          ملخص الاداء شهريا
        </h2>
