...
import { SpecializationSingleSelect } from '@/app/[locale]/(dashboard)/admin/_components/ui/specialization-single-select';
...
import { useAddAttachment } from '@/app/[locale]/(dashboard)/admin/_hooks/attachments/use-add-attachment';
import { useAttachmentMenuActions } from '@/app/[locale]/(dashboard)/admin/_hooks/attachments/use-attachment-menu-actions';
