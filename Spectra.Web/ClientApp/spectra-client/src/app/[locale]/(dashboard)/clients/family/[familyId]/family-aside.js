  ...
  const pages = [
    {
      ...
      isActive: path === '/'+params.locale+ROUTES.ADMIN.CLIENTS.FAMILY.DETAILS(params.familyId),
    },
    {
      name: "المواعيد",
      route: ROUTES.ADMIN.CLIENTS.FAMILY.APPOINTMENTS(params.familyId),
      isActive:
        path === '/'+params.locale+ROUTES.ADMIN.CLIENTS.FAMILY.APPOINTMENTS(params.familyId),
    },
    {
      name: "الوصفات الطبية",
      route: "",
    ...
    },
    {
      ...
      isActive: path === '/'+params.locale+ROUTES.ADMIN.CLIENTS.FAMILY.PATIENTS(params.familyId),
    },
  ];
