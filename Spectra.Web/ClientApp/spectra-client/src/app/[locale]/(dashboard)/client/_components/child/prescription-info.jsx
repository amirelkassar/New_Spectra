...
import { Info } from '@/app/[locale]/(dashboard)/client/_components/ui';
...
export const PrescriptionInfo = ({
  ...
  return (
    <div className='relative'>
      {showCard && <PrescriptionCard data={data} isDetailed />}

      <div
        className={cn('grid grid-cols-1 sml:grid-cols-3', className)}
      >
        <Info
