...
const DetailsAside = () => {
  ...
  const pages = [
    ...
    {
      name: 'الوصفات الطبية ',
      route: ROUTES.DOCTOR.CLIENTS.PRESCRIPTIONSPATIENTS(
        params.clientId
      ),
      isActive:
        path ===
          ROUTES.DOCTOR.CLIENTS.PRESCRIPTIONSPATIENTS(
            params.clientId
          ) ||
        path ===
    ...
    },
    {
      ...
      isActive:
        path ===
          ROUTES.DOCTOR.CLIENTS.REPORTPATIENTS(params.clientId) ||
        path ===
    ...
    {
      name: 'ملخص النشاطات',
      route: ROUTES.DOCTOR.CLIENTS.ACTIVITIESSPATIENTS(
        params.clientId
      ),
      isActive:
        path ===
        ROUTES.DOCTOR.CLIENTS.ACTIVITIESSPATIENTS(params.clientId),
    },
  ];
  return (
