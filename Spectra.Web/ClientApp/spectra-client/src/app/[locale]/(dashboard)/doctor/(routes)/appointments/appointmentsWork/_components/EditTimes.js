    ...
    <div className='p-4'>
      <div className='flex items-center gap-8 flex-wrap mb-6'>
        <div className='flex items-center gap-3'>
          <Link href={ROUTES.DOCTOR.APPOINTMENTSWORK}>
            <BackIcon
              className={'w-[30px] h-[30px] mdl:w-11 mdl:h-11'}
            />
          </Link>
      ...
      >
        {ModelOne ? (
          <div>
            <CalenderModalIcon
              className={'mx-auto h-[166px] w-auto mb-7'}
            />
            <h3 className='text-[28px] font-Bold text-center mb-2'>
              تعارض مواعيد
            </h3>
            <p className='text-xl font-Regular text-center mb-12'>
              الموعد الجديد الذي اخترته يتعارض مع مواعيد موجودة مسبقًا
              لمرضى لديك. يُرجى اختيار وقت آخر أو تعديل مواعيد المرضى
              المتأثرة.
            </p>
            <div>
          ...
          <div>
            ...
            <p className='text-xl font-Regular text-center mb-12'>
              أنت على وشك تغيير موعد قبل أقل من 48 ساعة من موعد مريضك
              المحدد، وهذا التغيير يتطلب دفع شرط جزائي طبقًا لسياسة
              سبيكترا.
            </p>
            <div>
              <h4 className='text-xl font-Bold text-center'>
