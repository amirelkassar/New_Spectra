...
import { ClientsData, MedicalTeamData } from '@/lib/demoData';
...
export const ClientsTable = () => {
  ...
  return (
    <Card className='space-y-5'>
      ...
      <div>
        {filter === 'الاطباء' && (
          <DataTable columns={doctorsColumns} data={MedicalTeamData} />
        )}

        {filter === 'العملاء' && (
          <DataTable columns={clientsColumns} data={ClientsData} />
        )}
      </div>
    </Card>
  );
