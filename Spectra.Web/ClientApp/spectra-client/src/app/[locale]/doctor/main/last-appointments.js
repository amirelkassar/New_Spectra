...
const LastAppointments = () => {
  ...
  return (
    <div className="rounded-xl bg-white p-0 md:p-8 grow">
      ...
      <TableComponents data={data} colNum={5} colNumSmall={4} hide={3} dataLine={1} header={['الاسم','اسم الطفل',"عدد الاطفال",'الميعاد','الحالة']}   haveImg={true} order={['name','patientName','numChild','time',"status"]} report={true} selectPage={selected} setSelected={setSelected} type={1} route={ROUTES.ADMIN.REQUESTS}  />
