  ...
  return (
    <div className='flex items-center gap-5 w-full'>
      ...
      <div className='flex items-center gap-3'>
        ...
        <Link
          href={ROUTES.DOCTOR.APPOINTMENTSWORKID(data.id)}
          className=' rounded-md duration-200 hover:shadow-md border border-greenMain  flex items-center justify-center p-1 w-8 mdl:w-10 h-8 mdl:h-10'
        >
