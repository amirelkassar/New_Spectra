  ...
  const pages = [
    {
      ...
      isActive: path === ROUTES.DOCTOR.CLIENTS.DETAILS(params.clientId),
    },
    {
      name: "الوصفات الطبية ",
      route: ROUTES.DOCTOR.CLIENTS.PRESCRIPTIONSPATIENTS(params.clientId),
      isActive:
        path === ROUTES.DOCTOR.CLIENTS.PRESCRIPTIONSPATIENTS(params.clientId) ||
        path ===
    ...
    },
    {
      ...
      isActive:
        path === ROUTES.DOCTOR.CLIENTS.ACTIVITIESSPATIENTS(params.clientId),
    },
  ];
  return (
