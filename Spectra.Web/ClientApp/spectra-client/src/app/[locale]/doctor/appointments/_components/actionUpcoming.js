...
function ActionUpcoming() {
  ...
  return (
    ...
    <Button
      ...
      className={
        "btnReqTable !py-0 text-[12px] lg:text-[14px] !px-2 min-w-[60px]  mdl:!min-w-[110px] flex font-bold items-center justify-center h-[38px] lg:h-11 ring-1 !ring-red text-red border-none"
      }
    >
      <DeleteIcon />
      <p>
        الغاء <span className=" hidden mdl:inline"> الميعاد</span>
      </p>
    </Button>
  </div>
  );
