  ...
  return (
    <div className="rounded-xl bg-white p-0 md:p-8 grow">
      <TableComponents
        ...
        hide={3}
        dataLine={1}
        header={["الاسم", "اسم الطفل", "عدد الاطفال", "الميعاد", "الحالة"]}
        haveImg={true}
        order={["name", "patientName", "numChild", "time", "status"]}
        report={true}
        selectPage={selected}
      ...
      <Pagination.Root
        ...
        value={valuePage}
        dir="ltr"
        className=" max-w-[1200px] mx-auto flex justify-between items-center mt-6 md:mt-[70px] px-[20px] md:px-[60px]"
      >
        <button
        ...
        >
          <ArrowLeft />
          <p className=" font-bold text-[14px] md:text-[16px] flex-1 leading-6">
            السابق
          </p>
        </button>
