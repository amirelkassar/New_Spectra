    ...
    <Card className={"h-full"}>
      ...
      <form className="max-w-[600px] mx-auto  flex flex-col gap-4 mdl:gap-6 mt-10 md:mt-14 md:mb-20">
        <PasswordInput
          ...
          classNames={{
            input: " h-12 mdl:h-14 rounded-xl border border-greenMain text-base mdl:text-lg",
        ...
        />
        <Button variant="secondary" className=" h-12 mdl:h-14 mt-10 mdl:mt-16 w-full max-w-[80%] mx-auto font-Bold text-base mdl:text-xl">تأكيد</Button>
      </form>
    </Card>
  );
}
