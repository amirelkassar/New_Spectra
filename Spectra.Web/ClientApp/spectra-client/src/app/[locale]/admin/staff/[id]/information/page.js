...
import { GetStaffID } from "@/useAPI/admin/staff/staff";
        ...
        <div className="w-full flex flex-col gap-6 flex-1">
          <div>
            ...
            <div className="grow grid w-full grid-cols-1 lg:grid-cols-2 lg:gap-y-2.5 lg:!mb-10 !mb-5 lg:gap-x-5">
              <CardInfo
                title={"الاسم كامل"}
                values={[data?.data.data.firstName]}
              />
              <CardInfo
                title={"النوع"}
                values={[data?.data.data.humenGenders === 1 ? "ذكر" : "انثي"]}
              />
              <CardInfo title={"البلد"} values={[data?.data.data.country]} />
              <CardInfo title={"المدينة"} values={[data?.data.data.city]} />
              <CardInfo title={"رقم الهاتف"} values={[data?.data.data.phoneNumbers]} />
              <CardInfo title={"البريد الالكترونى"} values={[data?.data.data.emailaddress]} />
              <CardInfo title={"رقم الهوية"} values={[data?.data.data.nationalId]} />
            </div>
          </div>
