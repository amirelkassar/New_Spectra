...
import { GetStaffID, useEditStaff } from "@/useAPI/admin/staff/staff";
...
function PageEditStaff({ id }) {
  ...
  const {
    ...
    isError,
    reset,
  } = useEditStaff(id, searchParams.get("type") === "Accountant" ? 3 : 4);
  useEffect(() => {
              ...
              <ul className="flex   flex-col gap-5 ">
                ...
                <li className="flex items-center gap-4 lg:gap-8">
                  ...
                  <DatePickerInput
                    ...
                    defaultValue={new Date(data?.data.data.timeToJoin)}
                    classNames={{
                      input:
