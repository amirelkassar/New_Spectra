...
import ActionMenu from "../_components/ActionMenuDoctor";
const data = {
  name: "احمد محمد كمال",
  spec: " اخصائى نفسى",
  brief:
...
function DoctorDEtails() {
  ...
  return (
    <div className="default-page2 relative lg:w-[calc(100%-246px)] max-w-[100%]  text-xl  !justify-start !items-start  text-start !gap-y-3 md:!gap-y-8 ">
      ...
      <div className="flex-1  mt-11">
        <div className="flex items-center justify-between gap-3 flex-wrap mb-8 md:mb-14 px-2 md:px-7">
          ...
          <button
            ...
            } h-[40px] md:h-[54px]  items-center gap-4 justify-between px-[24px] md:px-[34px] border py-2 md:py-3 rounded-[10px] border-solid w-fit md:w-[300px] border-[#939393]`}
          >
     ...
     <div className=" absolute top-6 z-10 end-5">
     <ActionMenu/>
     </div>
    </div>
  );
