...
function Page() {
  ...
  return (
    <Card>
      <h2 className="text-base mb-7 lg:text-xl font-bold">عقد المنظمة</h2>
      <div className="my-10">
        {file ? (
          <div className="flex items-center gap-5 justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="text-sm mdl:text-xl font-Regular mb-1">{file.name}</h4>
          ...
          <div className="w-[560px] max-w-[90%] mx-auto">
            ...
            >
              <div className="flex items-center flex-col h-full gap-5 justify-center">
                <UploadPdfIcon className={'w-11 h-auto mdl:w-[70px]'} />
                <h3 className="text-xs mdl:text-base text-center font-SemiBold">
                  اسحب الملفات وأفلتها أو{" "}
                  <span className="text-greenMain underline">اضغط هنا</span>
                </h3>
              </div>
            </Dropzone>
          </div>
