      ...
      <div className='col-span-1 lg:col-span-2 bg-white py-4 px-6 lg:p-12 lg:rounded-xl relative'>
        ...
        <div className='flex items-center gap-4 mb-6'>
          <Link
            ...
            className=' size-[26px]  md:size-[38px] flex items-center justify-center rounded-[50%] '
          >
            <BackIcon className={'w-full h-full'} />
          </Link>
          <h1 className=' text-sm mdl:text-medium block '>
            بيانات {title}
          </h1>
        </div>
        <div className='grid grid-cols-1 lg:grid-cols-2'>
          ...
          <div className='flex flex-row lg:flex-col items-center lg:items-start lg:justify-around'>
            <p className='text-nowrap w-[110px] md:w-auto text-[13px] md:text-[16px] flex items-center gap-1'>
              اخر دخول{' '}
              <span className='lg:hidden inline-block'>/</span>
            </p>
            <h2 className='text-[13px] md:text-[16px] font-bold'>
              25/4/2024
            </h2>
