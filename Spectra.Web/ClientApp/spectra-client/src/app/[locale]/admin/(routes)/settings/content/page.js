            ...
            <div className='mt-10 flex flex-col gap-6'>
              {sections.map((item) => {
                return (
                  <div
                    key={item.id}
                    className='flex items-center justify-between gap-4 flex-wrap pb-5 border-b border-grayLight mdl:pb-8 last-of-type:border-none'
                  >
            ...
            <div className='mt-10 flex flex-col gap-6'>
              {media.map((item) => {
                return (
                  <div
                    key={item.id}
                    className='flex items-center justify-between gap-4 flex-wrap pb-5 border-b border-grayLight last-of-type:border-none mdl:pb-8 '
                  >
                    <h3 className='text-[14px] md:text-[20px] font-bold'>
                      {item.title}
                    </h3>
