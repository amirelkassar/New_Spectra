  ...
  return (
    <div className=' flex-1'>
      ...
      <div className=' bg-white px-0 md:px-4 lg:px-6 xl:px-12 py-9 md:rounded-xl md:mb-7 border-y md:border-t-0 border-[#F5F5F5]'>
        <p className='text-[12px] md:text-[16px] font-Regular'>
          الكالسيوم الكلي في الدم هو اختبار دم يتم إجراؤه لقياس
          الأشكال الحرة والمقيدة للكالسيوم.
          <br /> غالبا ما يكون جزءا من اختبار الفحص للكشف عن مستويات
          الكالسيوم المرتفعة والمنخفضة بشكل غير طبيعي ، حيث يمكن أن
          يؤثر كلاهما على الصحة. <br /> التأثير على الصحة العامة؟
          <br /> يمكن أن تحدث مستويات غير طبيعية من الكالسيوم بسبب
          مشاكل في امتصاص الكالسيوم وأمراض العظام ،<br /> فرط نشاط
          الغدة الدرقية ، مرض الغدة الدرقية ، أمراض الكلى أو الكبد.
          <br /> كيفية تحسين الظروف الصحية؟
          <br /> بالنسبة لمستويات الكالسيوم المنخفضة ، فإن اتباع نظام
          غذائي يحتوي على الأطعمة الغنية بالكالسيوم هو التوصية
        </p>
      </div>
