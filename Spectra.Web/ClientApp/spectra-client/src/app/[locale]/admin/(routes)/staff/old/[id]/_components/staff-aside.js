  ...
  const pages = [
    ...
    },
    {
      ...
      route:
        ...
        searchParams.get('type'),
      isActive:
        path === ROUTES.ADMIN.STAFF.STAFFIDPRESCRIPTIONS(params.id),
    },
    ...
    },
    {
      ...
      route:
        ...
        searchParams.get('type'),
      isActive:
        path === ROUTES.ADMIN.STAFF.STAFFIDINFORMATION(params.id),
    },
    {
      name: 'العقد',
      route:
        ...
        searchParams.get('type'),
      isActive:
        path === ROUTES.ADMIN.STAFF.STAFFIDCONTRACTS(params.id),
    },
    {
      name: 'الفريق الطبى ',
      route:
