...
import ActionMenu from './_components/menuActionPrescriptions';
    ...
    <Card className=''>
      <div className='flex items-center  mb-10 justify-between gap-4'>
        <div className='flex   items-center gap-4 '>
          <Link
            href={ROUTES.ADMIN.CLIENTS.FAMILY.PRESCRIPTIONS(
              params.familyId
            )}
      ...
      <div className='flex flex-col gap-5'>
        ...
        <div className='pb-5 border-b last-of-type:border-none border-grayLight'>
          ...
          <p className=' font-Regular text-[12px] lg:text-[16px]'>
            الجرعة الأولية: 50 ملغ مرة واحدة يوميًا من الأقراص. لا
            تستخدم الكبسولات لبدء العلاج. <br />
            جرعة الاستمرارية: يمكن زيادة الجرعة بمقدار 25 ملغ
            أسبوعيًا.
        ...
        <div className='bg-blueLight rounded-xl px-8 py-7'>
          ...
          <p className=' text-[14px] lg:text-[20px] font-Regular pb-3 '>
            يحفظ العلاج في درجة حرارة الغرفة (15-25 درجة مئوية)،
            بعيدًا عن الرطوبة والحرارة، وبعيدًا عن متناول الأطفال.
          </p>
        </div>
      </div>
    </Card>
