...
const availableOptions = [
  {
    value: 'خدمة الكشف المبكر',
    label: 'خدمة الكشف المبكر',
  },
  {
    value: 'خدمة الاستشارات الفردية',
    label: 'خدمة الاستشارات الفردية',
  },
  {
  ...
  {
    value: 'خدمة دعم المراكز و الجهات',
    label: 'خدمة دعم المراكز و الجهات ',
  },
];
function ContentSpectra({ list = [], setList = () => {} }) {
  ...
  return (
    <Card className={'mdl:!ps-14 mdl:!py-8'}>
      <h3 className=' mb-5 text-xs mdl:text-base font-Regular'>
        محتوى الباقة
      </h3>
      ...
      <div className='flex items-center gap-4 bg-white'>
        <ul className='flex items-center gap-4 flex-wrap mb-6'>
          {Object?.entries({})?.map(([text, count], i) => (
            <li
              key={i}
            ...
            <div className='-mt-16'>
              <div className='mb-4'>
                <TextInput
                  ...
                  classNames={{
                    input:
                      '!border-none h-12 w-full text-sm mdl:text-xl font-Bold',
                  }}
                />
              </div>
