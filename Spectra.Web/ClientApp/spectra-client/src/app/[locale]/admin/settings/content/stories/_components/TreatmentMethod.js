...
function TreatmentMethod({ sectionsMethod, setSectionsMethod }) {
  ...
  return (
    <div className="mb-20">
      <h2 className="text-2xl font-Bold -mb-5">طريقة العلاج</h2>
      <div className="flex flex-col gap-11">
        {sectionsMethod.map((section, index) => (
          ...
          >
            <div className=" relative max-w-[440px] pt-16  w-full">
              <Textarea
              ...
              />
              <p className="absolute -top-16 right-5 text-[200px] font-Bold text-black/5 leading-[300px]">
                {index>=10 ? (index+1) : "0"+(index+1)}
              </p>
            </div>
            <div className=" relative max-w-full w-[480px]">
              {section.image ? (
                ...
                >
                  <div className="flex gap-4 py-8 flex-col justify-center h-[135px] w-full items-center">
                    <UploadImgIcon />
