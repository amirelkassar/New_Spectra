...
const dataArticle = [
  {
    id: 1,
    title:
      'الإدمان واضطراب فرط الحركة ونقص الانتباه (ADHD)',
    content:
          ...
          <div className='flex w-full flex-col gap-10'>
            {dataArticle.map((article) => {
              return (
                <div
                  key={article.id}
                  className='w-full pb-10 border-b border-grayDark last-of-type:border-none'
                >
                  <div className='flex items-center gap-5 mb-10'>
                    ...
                    >
                      <EditIcon className='text-greenMain' />
                      تعديل
                    </Link>
                  </div>
