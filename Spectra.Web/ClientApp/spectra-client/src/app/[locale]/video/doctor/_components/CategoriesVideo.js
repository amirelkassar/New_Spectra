...
function CategoriesVideo({ open }) {
  ...
  const CategoriesData = [
    {
      icon: (
        <ReportsGreenIcon className={'w-auto h-8 text-greenMain'} />
    ...
    {
      icon: (
        <PatientHistoryIcon className={'w-auto h-8 text-greenMain'} />
      ), // Replace with actual icon component
    ...
    {
      icon: (
        <InternalExamsIcon className={'w-auto h-8 text-greenMain'} />
      ), // Replace with actual icon component
    ...
    {
      icon: (
        <TransfersVideoIcon className={'w-auto h-8 text-greenMain'} />
      ), // Replace with actual icon component
      label: 'الإحالات',
      name: 'referrals',
    ...
    {
      icon: (
        <ComplaintsIcon className={'w-auto h-8 text-greenMain'} />
      ),
    ...
    {
      icon: (
        <NominationsIcon className={'w-auto h-8 text-greenMain '} />
      ),
      label: 'الترشيحات',
      name: 'nominations',
    ...
    <>
      ...
      <div className='flex lgl:flex-wrap gap-3 overflow-x-auto  snap-none hideScroll 	 max-w-[calc(100%-0px)] px-5 lgl:px-0 '>
        ...
        {open && isShowMore && !isShowAll && (
          <Other
            data={CategoriesData.slice(4, CategoriesData.length)}
          />
        )}
      </div>
    </>
