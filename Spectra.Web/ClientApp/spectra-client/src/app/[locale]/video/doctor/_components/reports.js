...
import { ReportCard } from '@/app/[locale]/(dashboard)/client/_components/child';
...
const dataReports2 = [
  {
    ...
    content: [
      ...
      },
      {
        id: 3,
        question:
          'هل عندما تقول شيئا ما أو تلوح بيدك يحاول طفلك تقليدك؟',
        answers: 'دائما',
      },
      {
        id: 4,
    ...
    content: [
      {
        id: 1,
        question:
          'يصدر صوتًا يجعلك تعلم إذا ما كان سعيدًا أو منزعجًا',
        answers: 'ليس بعد',
      },
      {
        id: 2,
    ...
    <div className='my-7 mdl:my-10'>
      {view && (
        ...
        >
          ...
          {view === 1 && (
            <h2 className='text-base font-Bold'>عرض التقارير</h2>
          )}
          {view === 2 && (
