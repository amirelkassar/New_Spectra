...
function page() {
  return (
    <div className="flex h-full flex-1 items-end justify-end flex-col-reverse lgl:flex-row">
      <div className="w-full  lgl:w-[400px] lgl:min-w-[400px] bg-white px-5">
        <LayCategories/>
      </div>
      <div className="bg-white lgl:bg-grayLight max-w-full lgl:rounded-s-3xl overflow-hidden lgl:flex-1 lgl:py-6 lgl:pe-10 lgl:ps-6">
