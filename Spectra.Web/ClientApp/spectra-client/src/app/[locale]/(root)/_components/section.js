...
export const Section = ({
  ...
  return (
    <section
      role='region'
      {...props}
      className='my-20 w-full max-w-5xl mx-auto'
    >
      {type === 'basic' && (
        <h2 id={id} className='text-2xl text-black leading-9 text-center mb-10'>
          {heading}
        </h2>
      )}
      {type === 'more' && (
        <div className='flex items-center justify-between mb-10'>
          <h2 id={id} className='text-2xl text-black leading-9'>
            {heading}
          </h2>
