...
export const Header = async () => {
  ...
  return (
    <header
      ...
      className='w-full flex py-8 z-50 xl:max-w-7xl mx-auto gap-x-12 items-center max-w-5xl container justify-between xl:justify-normal absolute top-0 end-1/2 rtl:-translate-x-1/2 ltr:translate-x-1/2'
    >
