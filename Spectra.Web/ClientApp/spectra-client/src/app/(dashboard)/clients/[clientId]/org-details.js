...
const Card = ({ title, values }) => {
  return (
    <div className="bg-white py-7 px-12 rounded-xl flex flex-col gap-4">
      <p>{title}</p>
      <div className="w-full grid grid-cols-2 gap-3 gap-y-2 ">
...
const OrgDetails = () => {
  return (
    <section className="grow grid grid-cols-2 gap-y-2.5 gap-x-5 ">
      <div className="col-span-2 bg-white p-12 rounded-xl">
        <h1 className="mb-6">بيانات المنظمة</h1>
