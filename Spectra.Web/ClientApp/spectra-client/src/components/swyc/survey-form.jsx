...
const Question = ({ children, ...props }) => {
  return (
    <div
      {...props}
      className={cn(
        'border-b-2 pb-6 border-grayLight w-full flex gap-x-3 gap-y-5 flex-col sml:flex-row sml:flex-wrap',
        props?.className
      )}
    >
      {children}
