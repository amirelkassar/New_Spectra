...
namespace Spectra.Infrastructure.Clients
{
    public class ClientService : IClientService
    {
        ...
        public async Task<string> CreateClient(CreateNormalClientDto input)
        {
        ...
        public async Task UpdateClient(string id, Name name, string nationalId, PhoneNumber phoneNumber, ClientTypes clientType, EmailAddress emailAddress, Address address)
        {
            var userId = _currentUser.Id;
